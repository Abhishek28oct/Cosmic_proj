          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
              ...
              <div className="lg:mx-auto text-left">
                ...
                <ul className="text-sm  transition-all duration-500">
                  <li className="mb-6">
                    <Link to="/night-sky-map" className="text-gray-400 hover:text-purple-400 transition-colors">
                      Night Sky Map
                    </Link>
                  </li>
                  <li className="mb-6">
                    <Link to="/guide" className="text-gray-400 hover:text-purple-400 transition-colors">
                      Guide
                    </Link>
                  </li>
                  <li className="mb-6">
                    <Link to="/learning-path" className="text-gray-400 hover:text-purple-400 transition-colors">
                      Learning Path
                    </Link>
                  </li>
                  <li>
                    <Link to="/printables" className="text-gray-400 hover:text-purple-400 transition-colors">
                      Printables
                    </Link>
                  </li>
                </ul>
              ...
              <div className="lg:mx-auto text-left">
                ...
                <ul className="text-sm  transition-all duration-500">
                  <li className="mb-6">
                    <Link to="/faqs" className="text-gray-400 hover:text-purple-400 transition-colors">
                      FAQs
                    </Link>
                  </li>
                  <li className="mb-6">
                    <Link to="/quick-start" className="text-gray-400 hover:text-purple-400 transition-colors">
                      Quick Start
                    </Link>
                  </li>
                  <li className="mb-6">
                    <Link to="/documentation" className="text-gray-400 hover:text-purple-400 transition-colors">
                      Documentation
                    </Link>
                  </li>
                  <li>
                    <Link to="/user-guide" className="text-gray-400 hover:text-purple-400 transition-colors">
                      User Guide
                    </Link>
                  </li>
                </ul>
              ...
              <div className="lg:mx-auto text-left">
                ...
                <ul className="text-sm  transition-all duration-500">
                  ...
                  <li className="mb-6">
                    <Link to="/tips-tricks" className="text-gray-400 hover:text-purple-400 transition-colors">
                      Tips &amp; Tricks
                    </Link>
                  </li>
                  <li className="mb-6">
                    <Link to="/updates" className="text-gray-400 hover:text-purple-400 transition-colors">
                      New Updates
                    </Link>
                  </li>
                  <li>
            ...
            <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
              <span className="text-sm text-gray-500">
                ©<Link to="/" className="hover:text-purple-400 transition-colors">Cosmic Horizons</Link> 2024, All rights reserved.
              </span>
              <div className="flex mt-4 space-x-4 sm:justify-center lg:mt-0">
                <a
                  ...
                  className="w-9 h-9 rounded-full bg-gray-700 flex justify-center items-center hover:bg-violet-600 transition-colors"
                >
                  <svg
