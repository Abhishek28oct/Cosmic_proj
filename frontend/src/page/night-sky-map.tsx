        ...
        <div className="min-h-screen bg-black text-white">
            ...
            <div className="relative h-[40vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-20 text-center px-4">
                    <h1 className="text-4xl md:text-6xl font-bold mb-4">Night Sky Map</h1>
                    <p className="text-lg text-gray-300 max-w-2xl mx-auto">
                        Explore the cosmos with our interactive star map
                    </p>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 py-12">
                <div className="bg-gradient-to-br from-gray-900 to-gray-800 p-8 rounded-xl border border-gray-700">
                    ...
                    <p className="text-gray-300">
                        Our interactive night sky map is currently under development. Stay tuned for an immersive experience that will help you explore the stars, planets, and celestial events in real-time.
                    </p>
                </div>
            </div>
